...
本サイト **Esprit** では、訪問者の方からのお問い合わせに対応する目的で、  
お問い合わせフォームを通じてお名前やメールアドレスなどの個人情報をお預かりすることがあります。  

収集した情報は、回答や連絡のためにのみ使用し、  
ご本人の同意なく第三者に提供・開示することはありません。  

本サイトでは、フォーム送信に **Formspree** などの外部サービスを利用します。
これらのサービスがデータを処理する際には、それぞれのサービス提供者のプライバシーポリシーに従います。  
